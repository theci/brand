...
전체 흐름을 **한 제품으로** 따라가려면 [`예시_시나리오.md`](../예시_시나리오/예시_시나리오.md)(고체 샴푸바 처음부터 끝까지)를 보세요.
...
제형을 실제로 만들고 개선하는 반복(iteration)을 돕는 3종 세트입니다. 자세한 흐름은 [`예시_시나리오_처방개선.md`](../예시_시나리오/예시_시나리오_처방개선.md) 참고.
